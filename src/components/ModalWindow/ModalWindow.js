    ...
    <div className={isModal ? 'modalWindow__wrapper' : 'modalWindow__wrapper modalWindow-disabled' }>
      ...
      <div className='modalWindow' >
        ...
        <form className='modalWindow-form'>
          <label className='modalWindow__label' for='modal-name' id="modalInput-name">Name must be between 3 characters and 30</label>
          <input className='modalWindow__input' type="text" id='modal-name' placeholder='Your name' value={name} onChange={(e) => handleNameInput(e)}/>
          <label className='modalWindow__label' for='modal-phone' id="modalInput-phone">The phone number must be in the format +7 (999) -999-99-99</label>
