  ...
  return (    
      <div className="card">
        <div className="card__image">
          <img src={recipe.images.SMALL.url} alt={recipe.label} onClick={() => handlerClick(data._links.self.href)}/>  
        </div>
        <div className="card__content">
          <span className="card__title" onClick={() => handlerClick(data._links.self.href)}>{recipe.label}</span>
